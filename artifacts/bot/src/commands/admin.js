...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body:
      ...
      `• ➕ *New Campaign* — ၉ ဆင့် wizard:\n` +
      `   နာမည် → ဆုရဖို့ ref အရေအတွက် → ဆုအမျိုးအစား (🪙MC / 💵KS / 🎁Bot Product အခမဲ့ / 📦Product ကိုယ်တိုင်ပို့) → ဆုပမာဏ/Product ရွေးချယ်မှု →\n` +
      `   max ref/user → max ဆု/user → *ဆုစုစုပေါင်း limit* → *ဖိတ်ခံရသူ acc သက်တမ်း အနည်းဆုံး (ရက်)* → *ဖိတ်ခံရသူ ပထမ topup အနည်းဆုံး (KS)*\n` +
      `• ⏹ *End* — campaign ပိတ် (မပြည့်သေးတဲ့ progress ပျက်၊ နောက် campaign အသစ် 0 ကစ)\n` +
      `• 📊 *Top ပါဝင်သူများ* — ဘယ်သူ ref ဘယ်နှစ်ယောက် ခေါ်ပြီးပြီ\n\n` +
      `🎁 *ဆုအမျိုးအစား ၂ မျိုး ကွာခြားချက်:*\n` +
      `• *🎁 Bot Product (အခမဲ့ ဝယ်ခွင့်)* — bot ထဲက ရောင်းနေတဲ့ product တစ်ခုကို ရွေး။ ref ပြည့်တဲ့သူ ဆီ *100% off coupon* အလိုအလျောက် ရောက် → Shop ထဲမှာ ကိုယ်တိုင် *အခမဲ့* ဝယ်လို့ရ (admin ဘာမှ လုပ်စရာ မလို)။ coupon က order စဉ် button အဖြစ် အလိုအလျောက်ပေါ်။\n` +
      `• *📦 Product (ကိုယ်တိုင်ပို့)* — ဆုနာမည် ရိုက်ထည့်ရုံ။ ref ပြည့်ရင် owner ဆီ "ပို့ပေးပါ" စာရောက် → admin က *ကိုယ်တိုင်* ပို့ရ။\n\n` +
      `🎬 *ဥပမာ — "ref 5 ယောက် = Weekly Pass အခမဲ့ ဝယ်ခွင့်" (ဆု 20 ခုပဲ):*\n` +
      `1️⃣ ➕ New Campaign → နာမည် → 5 → 🎁 Bot Product → Weekly Pass ရွေး → 0 → 1 → 20\n` +
      `2️⃣ \`/launchbroadcast\` နဲ့ ကြေညာ — ဝယ်သူတွေက \`/campaign\` မှာ progress ကြည့်နိုင်\n` +
      `3️⃣ တစ်ယောက်ယောက် ref 5 ယောက်ပြည့်ရင် → ဆုအလိုအလျောက်ရ (🎁 ဆို coupon ရ→Shop မှာ အခမဲ့ဝယ် / 📦 ဆို owner ဆီ "ပို့ပေးပါ" စာရောက်)\n` +
      ...
      `💰 *ပထမ topup အနည်းဆုံး စစ်ဆေးမှု:* ဖိတ်ခံရသူ ပထမဆုံး ငွေဖြည့်တာ သတ်မှတ်ပမာဏ (KS) မပြည့်ရင် campaign မှာ မတွက်ပါ (အသေးစား topup နဲ့ ဆုလုတာ ကာကွယ်ရေး)။ 0 = မစစ်ဘူး။ ပုံမှန် commission ကတော့ ရနေမြဲပါ (ဒီစည်းနဲ့ မသက်ဆိုင်)။`,
  },
  {
