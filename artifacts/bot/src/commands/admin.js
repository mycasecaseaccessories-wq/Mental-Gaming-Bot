...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    body:
      ...
      `➕ ထုတ်ပြီးရင် *📢 Channel မှာ ကြေညာမယ်* ခလုတ်နှိပ်ရင် — သိမ်းထားတဲ့ channel တွေ ခလုတ်နဲ့ပေါ်မယ်၊ တစ်ချက်နှိပ်ရုံ ကြေညာစာပို့နိုင်။ ပထမဆုံးအကြိမ်မှာ *➕ Channel အသစ်ထည့်ရန်* နဲ့ @username/ID ရိုက်ထည့်ရင် အလိုအလျောက် သိမ်းပေးထားမယ် (bot က channel admin ဖြစ်ရမယ်)။ 🗑 နဲ့ စာရင်းက ပြန်ဖျက်နိုင်\n\n` +
